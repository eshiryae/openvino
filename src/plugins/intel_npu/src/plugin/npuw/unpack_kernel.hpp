...
inline void unpack_impl(const ov::SoPtr<ov::ITensor>& from,
                        const ov::SoPtr<ov::ITensor>& to,
...
inline void unpack1_impl(const ov::SoPtr<ov::ITensor>& from,
                        const ov::SoPtr<ov::ITensor>& scale,
                        const ov::SoPtr<ov::ITensor>& to,
                        const UnpackOptions& unpack_options = UnpackOptions{true, 16, false}) {
    // This is in fact a weight decompression procedure
...
inline void unpack2_impl(const ov::SoPtr<ov::ITensor>& from,
                        const ov::SoPtr<ov::ITensor>& zerop,
                        const ov::SoPtr<ov::ITensor>& scale,
                        const ov::SoPtr<ov::ITensor>& to,
                        const UnpackOptions& unpack_options = UnpackOptions{true, 16, false}) {
...
inline void to_f16_impl(ov::Tensor& t) {
